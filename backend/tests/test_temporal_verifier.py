...
from app.query.temporal_verifier import L3_TEMPORAL_INVALID, verify_comparison_temporal, verify_temporal


def item(provision_id="p", start=date(2020, 1, 1), end=None, status="ACCEPTED"):
    return {"provision_id": provision_id, "effective_from": start, "effective_to": end, "review_status": status}
