...
- **Status**: Accepted
- **Context**: Chưa có bằng chứng model embedding nào vượt trội trên câu hỏi pháp luật tiếng Việt.
...
- **Consequences**: Benchmark có chi phí nhỏ (Jina 10M token miễn phí); chưa cam kết một model cho tới khi có kết quả.
- **Date**: 2026-07-19
