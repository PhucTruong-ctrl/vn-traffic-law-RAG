...
>
> **Model policy**: Không khóa tên model hoặc ngưỡng số trong tài liệu này khi chưa có benchmark; embedding local được benchmark nhỏ, cache candidate và chỉ rebuild index sau khi chọn cấu hình.
